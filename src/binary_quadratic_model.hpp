...
public:
    ...
    static BinaryQuadraticModel<IndexType_serial, FloatType_serial> from_serializable(const json &input)
    {
        ...
        //type might be another model, not "BinaryQuadraticModel" if the JSON object is generated by a child class of dimod.BinaryQuadraticModel. We do not check if the type name is the same as "BinaryQuadraticModel".
